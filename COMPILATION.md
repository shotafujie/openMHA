...
release in PDF format.  These files can also be re-generated:

Please install all dependencies for regular openMHA compilation on Linux first
(see above). The following additional prerequisites are needed for recreating
the documents:

- Ubuntu 22.04 or 26.04
- doxygen
- fig2dev
- graphviz
- texlive
...
Only on Ubuntu 26.04: 

`cp mha/doc/openMHAdoxygen-26.04.sty mha/doc/openMHAdoxygen.sty`

On both, Ubuntu 22.04 and 26.04:

`./configure && make doc`

The new pdf manuals will be created in the git root directory.  In addition,
HTML Doxygen documentation is generated in mha/doc/mhadoc/html/.
